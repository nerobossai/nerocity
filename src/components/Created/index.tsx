...
function CreatedAtComponent({ timeStamp, noHeader = false, fontSize = "14px", alignItems = "flex-end"}: { timeStamp: number, noHeader?: boolean, fontSize?: string, alignItems?: string; }) {
  ...
  return (
    <VStack alignItems={alignItems} gap="1px">
      {!noHeader && <Text fontSize="12px" color="text.100">
        CREATED
      </Text>}
